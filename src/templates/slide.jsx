...
export default ({ header = 'true', children }) => (
  <>
    ...
    <Footer css={headerFooterStyles} className="footer">
      <Separator />
      <FooterByline>
        Construyendo Sitios Accesibles con Gatsby ~  <span>by <a href="https://twitter.com/remediosgraphic">@remediosgraphic</a> basado en la presentacion de <a href="https://twitter.com/marcysutton">@marcysutton</a></span>
      </FooterByline>
    </Footer>
  </>
)
