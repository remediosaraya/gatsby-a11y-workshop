...
<div style="position: relative; margin:0 auto; max-width: 300px;">   
    <img src="../rob.png" alt="Roberto Remedios" style="max-height: 800px; margin: 100px 0; border-radius:50%; box-shadow: 10px 5px 5px grey; border:solid 10px #000;" />
    <img src="../puas.png" alt="Alfredo Navas" style="max-height: 800px; margin: 100px 0; border-radius:50%; box-shadow: 10px 5px 5px grey; border:solid 10px #000;" />
</div>
<p style="margin: 0;">
