...
<div style="position: relative; margin:0 auto; max-width: 800px;text-align:center;">   
    <img src="../rob.png" alt="Roberto Remedios" style="max-height: 800px; margin: 100px 20px; border-radius:50%;float:left; box-shadow: 10px 5px 5px grey; border:solid 10px #000;" />
    <img src="../puas.png" alt="Alfredo Navas" style="max-height: 800px; margin: 100px 20px; border-radius:50%;float:right; box-shadow: 10px 5px 5px grey; border:solid 10px #000;" />
</div>
<p style="margin: 0;">
...
Hacer que la web sea más inclusiva <br />
...
- Server-side render de páginas HTML
- "Hidratación" en las aplicaciones React.js
- Enrutamiento automático del lado del cliente
...
<img style="height: 90vh; margin-top: -1em;" src="../how-gatsby-works.png" alt="Cómo funciona Gatsby" />
...
<div>
    <a href="https://gatsbyjs.org/docs/cheat-sheet/" target="_blank">
        <img src="../cheat-sheet_page_1.png" alt="Gatsby Cheat Sheet página 1" style="max-height: 100vh" />
    </a>
</div>
...
<div>
    <a href="https://gatsbyjs.org/docs/cheat-sheet/" target="_blank">
        <img src="../cheat-sheet_page_2.png" alt="Gatsby Cheat Sheet página 2" style="max-height: 100vh" />
    </a>
</div>
...
- Produce páginas HTML por defecto
...
Online: https://remediosaraya.github.io/gatsby-a11y-workshop
...
# Probando esta aplicación Gatsby
Inicie una compilación en un navegador y comience a probar
...
Utiliza el API de accesibilidad de la plataforma para comunicar la estructura y el contenido de la página <br /> a las tecnologías de asistencia
...
El marcado semántico y los estilos CSS afectan el accessibility tree (árbol de accesibilidad)
...
# Componentes funcionales en acción.
...
_Mover el foco del usuario como parte de una interacción <br/> para alertarlo sobre nuevo contenido_

_También: manejo del foco en partes deshabilitadas y mutadas de la página_
...
Gestión del enfoque <br /> bloques de construcción
...
<span role="img" title="light bulb">💡</span> <em>Los lectores de pantalla van más allá de la tecla TAB</em>
</div>
...
Exponer información de accesibilidad para elementos enfocables.
...
<span role="img" title="light bulb">💡</span> <em>Destinado a elementos interactivos personalizados, no DIVs contenedores</em>
